...
wins.ts %>% 
  ...
  gghighlight(
    #aes(x = yearID, y = Running.W, color = nameFull),
    max(Win.Avg.Career), max_highlight = 15,
  ...
  ggtitle(
    "Top 10 Team Managers by Average Wins per Season",
    "1884 - 2019"
  ) +
  xlab("Year") +
...
#ggsave("Visualizations/Top Managers - Top Avg Wins per Season.png", width = 14, height = 8)
